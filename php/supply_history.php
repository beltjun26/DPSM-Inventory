...
<head>
	...
	<script type="text/javascript" src="../js/supply_history.js"></script>
	...
	<?php
		...
		include "functions/supply_history_functions.php";
	...
	<div class="container">
			...
			<div class="col-sm-4">
				<form id="search_form" method="post" action="<?php $_PHP_SELF; ?>">
					<div class="input-group">
						<input type="text" name="search_supply_history" id="search_supply_history" class="form-control" placeholder="Search table..."  value="<?php place_value();?>"/>
		...
		<div class="row">
			<div class="content_area col-xs-12 col-sm-12 col-md-12 sol-lg-12 table">
				<?php search_result_supply_history(); ?>
			</div>
		</div>
	</div>
