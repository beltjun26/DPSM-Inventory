...
<head>
	...
	<script type="text/javascript" src="../js/equipment_inventory.js"></script>
	...
	<div class="container">
		...
		<div class="row top-functions">
			<div class="col-sm-4">
				<form id="search_form" method="post" action="<?php $_PHP_SELF; ?>">
					<div class="input-group">
						<input type="text" name="search_equipment" id="search_equipment" class="form-control" placeholder="Search table..."  value="<?php place_value();?>"/>
			...
			<div class="col-sm-offset-5 col-md-offset-5 col-sm-3 col-md-3">
				<button class="btn btn-success new-borrower-btn" data-toggle="modal" data-target="#new_equipment_mod" aria-hidden="true" id="new_equipment"><span class="glyphicon glyphicon-plus"></span> New Equipment</button>
			</div>
		</div>
		<div id="datetime"></div>
		<div class="row">
			<div class="content_area col-xs-12 col-sm-12 col-md-12 sol-lg-12 table">
				<?php search_result_equipment(); ?>
			</div>
		</div>
	</div>
